...
public partial class ImbalanceGauge
{
    ...
    private string GetDashOffset()
    {
        ...
        return offset.ToString("F2", CultureInfo.InvariantCulture);
    }
    ...
    private string GetNeedleX()
    {
        ...
        return (50 + 35 * Math.Cos(angle)).ToString("F2", CultureInfo.InvariantCulture);
    }
    ...
    private string GetNeedleY()
    {
        ...
        return (50 - 35 * Math.Sin(angle)).ToString("F2", CultureInfo.InvariantCulture);
    }
}
